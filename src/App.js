...
function displayTodayTasks(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/getTodayTasks';
...
function displayOverdueTasks(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/getOverdueTasks';
...
function commitTask(event){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/commitTask';
...
function addTask(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/addTask';
...
function displayHomesAllTasks(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/displayHomesAllTasks';
...
function displayAllTasks(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/displayAllTasks';
...
function deleteTask(event){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/deleteTask';
...
function addHome(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/addHome';
...
function showHomes(){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/showHomes';
...
function addUser(event){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/addUSerToHome';
...
function collectLogin(event){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/login';
...
function collectRegister(event){
	...
	const apiUrl = 'http://127.0.0.1:3001/api/register';
...
function existEmail(email){
	const apiUrl = 'http://127.0.0.1:3001/api/existEmail';
